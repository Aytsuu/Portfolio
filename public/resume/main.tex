...
\begin{center}
    ...
    {\faBriefcase\ \underline{\href{https://paoloaraneta.dev/}{paoloaraneta.dev/}}}
    \vspace{-8pt}
\end{center}
    ...
    \resumeSubHeadingListStart
      \resumeSubheading{Project Management $|$ Lead Application Developer}{Oct 2024 -- Present}{Cebu Technological University}{Cebu City, Philippines} 
        \resumeItemListStart
          ...
          \resumeItem{Led the development of \textbf{Securado} a real-time GPS and GSM tracking system capable of transmitting live coordinates to the cloud.}
...
\section{Projects} 
    \vspace{-5pt}
    \resumeSubHeadingListStart
    \resumeProjectHeading{\textbf{Securado} $|$ \emph{Web, Mobile}}{React, TypeScript, Python, Django, PostgreSQL}
      \resumeItemListStart
        ...
        \resumeItem{Crafted an API to transmit report data to Barangay San Roque (Ciudad).}
      \resumeItemListEnd
    \vspace{-20pt}
    \resumeProjectHeading
      {\textbf{Barangay San Roque (Ciudad)} $|$ \emph{Web, Mobile}}{React, TypeScript, Python, Django, PostgreSQL}
      \resumeItemListStart
        \resumeItem{Developed a barangay management system with automated Know Your Customer (KYC) verification and assessment for resident registration in barangay San Roque (Ciudad), Cebu City.}
        \resumeItem{Synchronized dual databases to ensure consistent real-time data access.}
        \resumeItem{Set up CI/CD pipelines with GitHub Actions for integration testing and deployed the web application via Render.}
      \resumeItemListEnd
    \vspace{-20pt}
    \resumeProjectHeading
      {\textbf{Vision} $|$ \emph{Web}}{React, Javascript, Python, Flask, MongoDB}
      \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{   
      ...
      \textbf{Frameworks}{: Django, Flask, FastAPI, Node.js, React, Next.js, TailwindCSS} \\[1mm]
