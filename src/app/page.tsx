  ...
  return (
    <>
      ...
      <div className="flex lg:hidden py-4 flex-col gap-6">
        ...
        <div className="space-y-4 px-4">
          <div className="flex flex-col items-center">
            <h1 className="flex flex-row gap-2 text-base font-semibold items-center">
              Paolo Araneta
              <img src={"/assets/icons/check-badge.svg"} className="w-4 h-4" />
            </h1>
          ...
          >
            ...
            <div className="space-y-3">
              <p className="text-sm leading-5">
                ...
                building web applications using JavaScript (TypeScript), Python,
                and SQL. Solving real-world problems through well-designed,
              ...
              <p className="text-sm leading-5">
                ...
                maintainable code and continuously explore new technologies and
                best practices to improve my work and stay current in a
        ...
        {/* Experience */}
        <div className={`space-y-4 p-4 ${theme === "dark" ? "bg-[#0A0A0A]" : "bg-[#E9ECEF]"}`}>
      ...
      <div className="w-full mx-auto hidden lg:block lg:max-w-360 p-10 transition-colors">
        ...
        <div className="flex flex-row gap-20">
            ...
            <div className="sticky top-21 flex flex-col justify-between h-[calc(100vh-160px)]">
              ...
              <div className="flex flex-col gap-6">
                {["About", "Tech Stack", "Projects"].map((menu) => (
                  <div className="flex flex-row items-center gap-6" key={menu}>
                    <div
                    ...
                    <h1
                      className={`font-medium ${
                        activeSection == menu.toLowerCase() ? "" : "opacity-60"
                      }`}
                    >
                      {menu}
                    </h1>
                  ...
                  {experiences.map((exp, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col px-5 pb-5 gap-2">
                        ...
                        <Badge variant={"outline"} className="rounded-sm">{exp.year}</Badge>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="w-1/2 flex flex-col pt-10 gap-16 z-5">
            ...
            {/* TECH STACK */}
            <SectionWrapper id="tech stack" setActiveSection={setActiveSection}>
              <div className="flex flex-col gap-10">
                {Object.entries(techStacksHomePage).map(([key, val], index) => (
                  <div className="flex flex-col gap-6" key={`${key}-${index}`}>
                    <h1 className="font-medium">{key}</h1>
                    <div className="flex flex-wrap gap-3">
                      {val.map((stack) => (
                        <Badge className="min-w-24 py-1.5 px-4" key={`${key}-${stack}`}>
                          {stack}
                        </Badge>
                      ))}
                    </div>
